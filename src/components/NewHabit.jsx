...
export default function NewHabit({ onClose }) {
    return (
                    ...
                    <div className="habitInput habitCategories">
                        ...
                        <div className="habitCategoryBlock">
                            ...
                            <button className="habitCategory">
                                ...
                                <div className="habitCategoryText" id="habitHealth">Health</div>
                            </button>
                            <button className="habitCategory">
                                <div className="habitCategoryIcon">
                                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="habitCategoryText" id="habitWork">Work</div>
                            </button>
                            <button className="habitCategory">
                                <div className="habitCategoryIcon">
                                ...
                                <div className="habitCategoryText" id="habitSpirit">Spirit</div>
                            </button>
                        </div>
                        <div className="addOwnCategory"><b>+</b> OR ADD CUSTOM CATEGORY</div>
                    </div>
                    <div className="habitInput habitFrequency">
                        <div className="habitFrequencyHeader">Frequency</div>
                        <div className="habitFrequencyBlock">
                            <button className="habitFrequencyItem">Daily</button>
                            <button className="habitFrequencyItem">Weekly</button>
                            <button className="habitFrequencyItem">Monthly</button>
                            <button className="habitFrequencyItem">Custom</button>
                        </div>
                    </div>
                </div>
