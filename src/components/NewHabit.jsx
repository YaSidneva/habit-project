...
export default function NewHabit({ onClose, onSave }) {
    ...
    return (
        <div className="newHabitOverlay" onClick={onClose}>
            <div className="newHabitContainer" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="newHabitContainerFooter">
                    <button className="newHabitContainerButton newHabitContainerButtonCancel" onClick={onClose}>Cancel</button>
                    <button className="newHabitContainerButton newHabitContainerButtonStart" onClick={handleSave}>Start Climbing</button>
                </div>
            </div>
        </div>
    )
